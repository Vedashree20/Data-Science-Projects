...
import re
#images = convert_from_path('invoice_7.pdf',500,poppler_path=r'C:\Users\Admin\OneDrive\Desktop\poppler-21.10.0\Library\bin')#replace paths
...
image = Image.open('invoice_7.png')#replace name
